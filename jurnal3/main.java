...
public class main{
    public static void main(String[] args){
        ...
        link<dataBuku> linkedList = new link<>();
        ...
        do {
            ...
            switch(pilihan){
                case 1 : 
                    ...
                    switch(option){
                        case 1:
                            linkedList.insertAtFront(new dataBuku(judul, penulis, tahunTerbit));
                            break;
                        case 2:
                            linkedList.insertAtBack(new dataBuku(judul, penulis, tahunTerbit));
                            break;
                        default:
